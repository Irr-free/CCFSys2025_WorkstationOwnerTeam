...
void Backend_Source_Core_Single(int Core_ID,
    ...
    static queue<int> update_v_id_buffer[CORE_NUM], pull_first_flag_buffer[CORE_NUM]; //edge_buffer[CORE_NUM];
        ...
        *Rd_Vertex_BRAM_Valid = 0;
        ...
        if (Om1_Recv_Update_V_DValid && Om1_Recv_Push_Flag == 0) {
            ...
            *Rd_Vertex_BRAM_Valid = 1;
            ...
            //edge_buffer[Core_ID].push(Om1_Recv_Update_V_Value);
        }
        else {
            *Rd_Vertex_BRAM_Addr = 0;
            *Rd_Vertex_BRAM_Valid = 0;
        ...
        *Om2_Send_Update_V_DValid = 0;
        ...
        if (Vertex_BRAM_DValid) {
            ...
            *Om2_Send_Update_V_Value = (Vertex_BRAM_Data == -2 ? Om_Global_Iteration_ID : Vertex_BRAM_Data);
            //caches[update_v_id_buffer[Core_ID].front()%CORE_NUM].put(edge_buffer[Core_ID].front(),(Vertex_BRAM_Data == -2 ? Om_Global_Iteration_ID : Vertex_BRAM_Data));
