...
void RD_ACTIVE_VERTEX_SINGLE(int Core_ID,
    ...
    #else
        int now_push_flag = push;
        int next_push_flag = push;
...
//                }
                ...
                if (vis_bitmap_index[Core_ID] < BitMap_Compressed_NUM && pull_first_active_vertex_bitmap == 0) {
                    *Push_Flag = now_push_flag;
                ...
                if (init_bitmap_id[Core_ID] == BitMap_Compressed_NUM) {
                    if (vis_bitmap_index[Core_ID] < init_bitmap_id[Core_ID]) {
                        ...
                        if (pull_first_active_vertex_bitmap == 1) {
                            ...
                            if (!NextStage_Full && !(Backend_Active_V_DValid && Backend_Active_V_Pull_First_Flag == 1 && Backend_Active_V_Updated == 0)) {
