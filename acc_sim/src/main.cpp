...
int rst_rd;
int rst_root;
int ROOT_ID = 1;//993893 413575 74645 614395 339097 583795 882951 830639 210392 110028
...
vector<LRUCache<int, int>> caches(CORE_NUM, LRUCache<int, int>(256));
...
#endif
{
    ...
    #else
        Initialize_Input_Graph("edge_off3.txt", "edge_list3.txt");
    #endif
    ...
    for (clk = 0; clk < MAX_CYCLE; ++ clk) {
        ...
        if(vertex_updated==46686)exit(clk);
        #if DEBUG
...
//        for (int i = 0; i < CORE_NUM; ++ i){
//            if(P6_Update_V_ID_rd[i]==66 && P6_Push_Flag_rd[i]==0){
//                cout<<clk<<":66come1!!"<<endl;
//            }
//            if(P7_Om2_Send_Update_V_ID_rd[i]==66 && P7_Om2_Send_Push_Flag_rd[i]==0){
//                cout<<clk<<":66come2!!"<<endl;
//            }
//        }
        HyperX_Network_P(P6_Push_Flag_rd, P6_Update_V_ID_rd, P6_Update_V_Value_rd, P6_Pull_First_Flag_rd, P6_Update_V_DValid_rd, P6_Iteration_End_rd, P6_Iteration_End_DValid_rd,
...
//        for (int i = 0; i < CORE_NUM; ++ i){
//            if(Om1_Update_V_ID_wr[i]==66 && Om1_Push_Flag_wr[i]==0 && Om1_Update_V_Value_wr[i]==1){
//                cout<<clk<<":66out1!!"<<endl;
//            }
//            if(Om2_Update_V_ID_wr[i]==66 && Om2_Push_Flag_wr[i]==0 && Om2_Update_V_Value_wr[i]==0){
//                cout<<clk<<":66out2!!"<<endl;
//            }
//        }
...
//        for (int i = 0; i < CORE_NUM; ++ i){
//            if(P7_Wr_Vertex_BRAM_Addr_wr[i]==66 && P7_Wr_Vertex_Bram_Push_Flag_wr[i]==0){
//                cout<<clk<<":66ready!!"<<endl;
//                cout << P7_Wr_Vertex_BRAM_Addr_wr[66] << " " << P7_Wr_Vertex_BRAM_Data_wr[66] << " " << P7_Wr_Vertex_BRAM_Pull_First_Flag_wr[66] << " " << P7_Wr_Vertex_BRAM_Valid_wr[66] << endl;
//            }
//        }
...
//        for (int i = 0; i < CORE_NUM; ++ i){
//            if(Backend_Active_V_ID_wr[i]==66 && Backend_Active_V_Updated_wr[i]==1){
//                cout<<clk<<":66update!!"<<endl;
//            }
//        }
